...
#### 2.4GHz
Has better range but more interference. 2.4GHz is *compatible with all WiFi generations*. There is more interference on 2.4 due to other devices and protocols sharing the same frequency (such as bluetooth and microwave).
...
#### 6GHz
The 6GHz band was introduced in Wi-Fi 6E. it offers more bandwidth and channels and significantly reduced interference. It's mostly used for high-bandwidth applications in environments w/ many devices.
![](../networking-pics/802-11-9.png)
### Data Transfer Rates
